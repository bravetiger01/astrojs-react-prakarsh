    ...
    >
      ...
      <div
        ...
        style={{
          ...
          transition:
            "border-color 0.35s ease, transform 0.3s ease, box-shadow 0.3s ease",
          transform: hovered
      ...
      >
        ...
        <div
          ...
          style={{ aspectRatio: "3/4", maxHeight: "52%" }}
        >

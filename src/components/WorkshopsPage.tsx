...
const WorkshopsPage = () => {
  const { events: workshopEvents, loading } = useEventsByCategory("workshops");
  return (
      ...
      <main className="relative z-10">
        ...
        <div className="pt-32 pb-16 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-black mb-6 text-neon-green">
                Workshops
              </h1>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Learn, create, and innovate with hands-on workshops. Master new
                skills and explore emerging technologies with expert guidance.
              </p>

              <p className="text-sm text-muted-foreground mt-4">
                {workshopEvents.length} workshop
                {workshopEvents.length !== 1 ? "s" : ""} available
              </p>
            </motion.div>
            ...
            {!loading && workshopEvents.length === 0 && (
              <div className="text-center py-20">
                <p className="text-muted-foreground text-lg">

...
export class CyberBuildfront extends PIXI.Container {
    constructor() {
        super();

        // 1. BASE (Static)
        // Coords: x=831, y=875, w=699, h=949
const cyberBuildfront = Resources.getSubTexture(
  'bigThing',
  0,
  2417,
  3066,
  1637
        ...
        this.peachCloudBackSprite = new PIXI.Sprite(cyberBuildfront);
